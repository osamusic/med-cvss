...
export const MitreCVSSRubric: React.FC<MitreCVSSRubricProps> = ({ onVectorChange }) => {
  ...
  useEffect(() => {
    ...
    const categories = ['Attack Vector', 'Attack Complexity', 'Privileges Required', 'User Interaction', 'Scope', 'Confidentiality Impact', 'Integrity Impact', 'Availability Impact'];
        ...
        <div className="question-header">
          <div className="question-meta">
            ...
            <span className={`question-type ${question.type}`}>
              {question.type === 'decision' ? '🔄' : question.type === 'classification' ? '📋' : '📊'}
  ...
  const questionsByCategory = visibleQuestions.reduce((acc, question) => {
  ...
  return (
    <div className="mitre-cvss-rubric">
      <div className="mitre-header">
        ...
        <p>Structured assessment following MITRE's medical device cybersecurity evaluation framework</p>
        ...
        <div className="completion-summary">
          {stats.answered === stats.total && stats.total > 0 ? (
            ...
            <div className="completion-message">
              📋 Follow the flowchart by answering questions to complete your medical device CVSS assessment
            </div>
          )}
        </div>
      </div>
